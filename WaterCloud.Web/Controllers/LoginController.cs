    ...
    public class LoginController : Controller
    {
        ...
        public ActionResult CheckLoginState()
        {
            try
            {
                ...
                //对比用户缓存sessionId
                if (CacheFactory.Cache().GetCache<string>(userId) != sessionId)
                {
                    return Content(new AjaxResult { state = ResultType.error.ToString() }.ToJson());
                }
                //else
        ...
        public ActionResult CheckLogin(string username, string password, string code)
        {
            ...
            try
            {
                ...
                UserEntity userEntity = new UserApp().CheckLogin(username, password, sessionid);
                ...
                if (userEntity != null)
                {
                    ...
                    operatorModel.SessionId = sessionid;
